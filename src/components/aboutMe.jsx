...
function AboutMe() {
  return (
    <div id='aboutme' className="w-full h-[100vh] flex flex-col justify-center items-center md:flex-row  pt-[10vh] md:w-[70vw] md:min-w-[728px]">
      ...
      <div className='w-full h-[50vh]  md:h-full md:flex md:flex-col md:gap-[2vh] md:items-center md:justify-center'>
        ...
        <p className="cu-font---anaheim-Regular px-[10vw] font-medium leading-0 md:text-[1.5rem] md:px-[3%] md:leading-8">
